                ...
                <?php
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        try {
                            ...
                            $query = "SELECT * FROM seller WHERE username = $1";
                            ...
                            if ($user_data = pg_fetch_assoc($result)) {
                                ...
                                echo '<p class="create-account-link"><a href="illsell_createaccount.php">Create an account</a></p>';
                            }
